...
for ooweight_on = 1.5
    for ooweight_off = 2.5
        ...
        [tsh, tsf, cc, dd, ss, ff] = generatenewsegmentation_mono(allenall, '', '', 'filelist.m', 'AMMeanPlain250', 'NewSegments', segparams, 'assesseg', 0, 'epsilon_start', 0.03,'epsilon_end', 0.04,  ...
            'display', 0, 'silent', 1) ;
