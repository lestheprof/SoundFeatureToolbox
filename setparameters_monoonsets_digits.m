function setparameters_monoonsets_digits(stimulibasedir, experimentname, dirname)
...
% add a timestamp
AN.dateStr = string(datetime) ; % lss April 2025. 
AN.soundlength = 20; %  20 seems to be about the absoulte maximum
...
AN.fmax = 3500; % for digits, 8Ks/s sampling so less than 4000
AN.channels = 10; % 12 * log2(4500/50) = 77, so 100 is a bit more than 1/semitone. Normally 200; % was 32/64
...
AN.multiplier = 2 ; % root 2: 3dB difference: 2 = 6dB
AN.iterations = 8 ; %8=24dB 10 is also good.
...
onset.onsetcellwt_wide =  11000/21 ; % weight to onset cell was 1500 for spread-wide = 2 (was 10000 for single AN input)
...
save([stimulibasedir  experimentname  dirname '/' 'parameters_monoonset'], 'AN', 'corrparam', 'onset') ;
