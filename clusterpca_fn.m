function clusterpca_fn(timitlocn, vdirectory, ngabors, outputfilename, varargin)
...
%
% modded 1 April just to do the PCAs. Another function will do ICAs
% (differently)
...
while(i<=size(varargin,2))
    switch lower(varargin{i})
        ...
        otherwise
            error('clusterpca_fn: Unknown argument %s given',varargin{i});
    end
    i=i+1;
end
...
save([timitlocn '/' '/' vdirectory '/' outputfilename '_pca_f'], 'line1to8_km5_pca',  'cpca5', 'pcaparams') ;
...
save([timitlocn '/' vdirectory '/' outputfilename '_pca_m'], 'line1to8_km5_pca',  'cpca5', 'pcaparams') ;
end
