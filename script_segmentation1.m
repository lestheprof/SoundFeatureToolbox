...
for ooweight_on = 2.0
    for ooweight_off = 1.6
        ...
        [tsh, tsf, cc, dd, ss, ff] = generatenewsegmentation_mono(allensubset, '', '', 'temp.txt', 'ANMeanPlain250', 'NewSegments', segparams, 'assesseg', 1, 'epsilon_start', 0.03,'epsilon_end', 0.04,  ...
            'display', 0, 'silent', 1) ;
