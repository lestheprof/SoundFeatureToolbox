function setparameters_monoonsets_birdsong(stimulibasedir, experimentname, dirname)
...
% for experimentation
AN.fmin = 100; % was 150 (was 100) Nothing interesteing at LF
AN.fmax = 5000; % for birdsong, some sample rates are 11025.TIMIT, normally 6500; % was 10000 (was 8000)
AN.channels = 100; % 12 * log2(4500/50) = 77, so 100 is a bit more than 1/semitone. Normally 200; % was 32/64
...
onset.onsetcellwt_wide =  800 ; % weight to onset cell was 1500 for spread-wide = 2 (was 10000 for single AN input)
onset.spread_wide = 4 ; % number of AN fibers on each side of centre (0->no spread) (was 2)
