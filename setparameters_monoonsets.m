...
AN.soundlength = 30; % 3 mins 20 seems to be about the absoulte maximum
...
AN.fmax = 7000; % was 10000 (was 8000)
AN.channels = 100; % was 32/64. Log_2(fmax/fmin) * 12 would be one per semitone. 
AN.N_erbs = 1.0 ; % 1 is normal bandwidth. 4 is wide
...
% weight to onset cell was 1500 for spread-wide = 2 (was 10000 for single AN input)
...
% onset.depsynparams_wide = [100 2000 20] ;
