function setparameters_monoonsets(stimulibasedir, experimentname, dirname)
...
% added am parameters July 25 2013 LSS
...
onset.onsetcellwt_wide =  11000/11 ; % weight to onset cell was 1500 for spread-wide = 2 (was 10000 for single AN input)
onset.spread_wide = 5 ; % number of AN fibers on each side of centre (0->no spread) (was 2)
...
am.depsynparams = [500 1100 200] ; % initial values from email from Madhu were[500 1100 25]
am.dissconst = 1.5; % certainly considerably greater than onset.diss
am.fmaxdiss = 4000 ; % seems a reasonable limit
am.minfrequency = 800 ; % unlikely to seek AM below this frequenct
am.threshold = 1 ; % seems reasonable
am.refperiod = 0.002 ; % a little less than half of 1/fmax AM.
am.inhibparams = [0.005 1 0.002] ; % 1st is the duration of inhibition, second is degree of inhibition (1 = total, 0 = none),
% third is delay (the onset times are reduced by this value)
