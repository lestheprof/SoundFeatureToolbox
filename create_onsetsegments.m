function [ numberofsegments, segarray, filelist ] = create_onsetsegments(stimulibasedir, experimentname,dirname, input_filelist, bmSigdir, onsetSigDir, onsetqualifier, prestart,duration)
