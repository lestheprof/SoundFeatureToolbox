function [classifications_pca, classifications_ica] = classifysounds1_fn(soundlocation, filelist, soundclasslocation, ANSigDir, AMMeanPlain250, onsetSigdir, onsetMeans250, ...
